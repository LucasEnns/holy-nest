...
<div class="settings">
   <div class="input-wrapper">
      <h5 data-lang="{userLang}" data-fr="Materièl L x H x É">
         <span>Material W x H x T</span>
      </h5>
      <input
         class="input"
         type="number"
   ...
   <div class="input-wrapper">
      <h5 data-lang="{userLang}" data-fr="outil découpe">
         <span>Tool Kerf</span>
      </h5>
      <input
         class="input"
   ...
   <div class="input-wrapper">
      <h5 data-lang="{userLang}" data-fr="Unités">Units</h5>
      <label class="switch"><input type="checkbox" bind:checked={$settings.units} ><div class="slider" data-lang="{userLang}"></div></label>
   </div>
</div>
